    ...
    <>
      ...
      <div className=" w-full h-[600px] overflow-hidden relative bg-(--neutral) flex pt-50 flex-col items-center">
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="show"
          className="font-bold text-blue-900 pb-2 md:text-7xl sm:text-6xl text-3xl text-center ">
        ...
        <p className="capitalize md:text-4xl text-gray-900 text-center pb-5">Simplify your first-time experience. instantly.</p>
      ...
      <p className='font-bold md:text-4xl text-gray-900 text-2xl'>Our Partners</p>
